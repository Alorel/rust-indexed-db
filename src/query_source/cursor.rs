...
impl<'qs, K, Qs, Q, D> AnyCursorBuilder<'qs, K, Qs, Q, D> {
    ...
    pub fn with_query<QK, I>(self, query: I) -> AnyCursorBuilder<'qs, K, Qs, crate::KeyRange<QK>, D>
    where
        I: Into<KeyRange<QK>>,
    {
        AnyCursorBuilder {
...
impl<'qs, K, Qs, Q, D> Clone for AnyCursorBuilder<'qs, K, Qs, Q, D>
where
    Q: Clone,
    D: Clone,
{
