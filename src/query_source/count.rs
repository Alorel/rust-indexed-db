...
#[sealed]
impl<'q, Qs, Sys> crate::BuildPrimitive for Count<'q, Qs>
where
    Qs: SystemRepr<Repr = Sys>,
    Sys: QuerySourceInternal,
{
...
#[sealed]
impl<'q, Qs, Sys, KR> crate::BuildPrimitive for Count<'q, Qs, KeyRange<KR>>
where
    Qs: SystemRepr<Repr = Sys>,
    Sys: QuerySourceInternal,
    KeyRange<KR>: TryToJs,
...
const _: () = {
    ...
    #[sealed]
    impl<'a, Qs, Sys> crate::BuildSerde for Count<'a, Qs>
    where
        Qs: SystemRepr<Repr = Sys>,
        Sys: QuerySourceInternal,
    {
    ...
    #[sealed]
    impl<'a, Qs, Sys, KR> crate::BuildSerde for Count<'a, Qs, KeyRange<KR>>
    where
        Qs: SystemRepr<Repr = Sys>,
        Sys: QuerySourceInternal,
