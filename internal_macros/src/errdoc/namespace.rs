...
impl_namespaces!(Namespace(
    ...
    Database(
        ...
        InvalidStateErrorObjectStore("Thrown if the method was not called from a [`Versionchange`](crate::TransactionMode::Versionchange) transaction callback."),
        ...
        TypeErrorTx("Thrown if the value for the mode parameter is invalid. Only applicable in browser incompatibility contexts."),
        InvalidAccessErrorTx("Thrown if the fn was called with an empty list of store names."),
    ),
    ObjectStore(
        ReadOnlyError("Thrown if the transaction associated with this operation is in [`Readonly`](crate::TransactionMode::Readonly) mode."),
        TransactionInactiveError("Thrown if the transaction associated with this operation is inactive."),
    ...
    Index(
        ...
        InvalidStateError("Thrown if the method was not called from a [`VersionChange`](crate::TransactionMode::Versionchange) transaction mode callback or the object store has been deleted."),
...
name_msg!(fwd(QuerySource, Transaction, Index));
